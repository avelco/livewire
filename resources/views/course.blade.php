...
@section('content')
        ...
        <div class="p-8 bg-gray-200 col-span-1">
            <ul class="flex flex-col">
                ...
                <li class="flex items-center text-gray-600 mt-2">
                    {{$post->name}}
                    @if ($post->free)
                    <span class="text-xs text-gray-500 font-semibold bg-green-300 px-2 rounded-full ml-auto">Gratis</span>    
                    @endif
                </li>
                @endforeach
            </ul>
        </div>
        <div class="text-gray-700 cols-span-2">
    ...
    <div class="text-center mt-4">
        ...
        <h2 class="text-xl text-gray-600">Fórmate en tecnología</h2>
    </div>
